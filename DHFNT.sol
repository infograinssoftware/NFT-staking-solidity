...
contract DHFNT is ERC721 {
    ...
    mapping(uint256 => Dhfnt) public allDhfnt;
    ...
    function mintDhfnt(
        ...
        DhfntCounter++;
        require(!_exists(DhfntCounter));

        require(!tokenURIExists[_tokenURI]);
        require(!tokenNameExists[_name]);

        _mint(msg.sender, DhfntCounter);
        _setTokenURI(DhfntCounter, _tokenURI);
        ...
        allShroomieS[DhfntCounter] = newShroomY;
    }
